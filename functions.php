...
function themeConfig($form) {
    ...
    _e('<div id="typecho-welcome">
            <h3>欢迎使用 <a href="https://github.com/Yolo913/typecho-theme-book">Typecho Theme Ringo</a>！ <img src="https://img.shields.io/github/stars/Yolo913/typecho-theme-book.svg?style=social"></h3s>
            <li>Powered By <a href="http://www.liuyl.xyz">Yolo913</a></li>
